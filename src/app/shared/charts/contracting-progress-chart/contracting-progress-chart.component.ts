...
@Component({
    ...
    templateUrl: './contracting-progress-chart.component.html',
    styles: []
})
export class ContractingProgressChartComponent implements OnInit, AfterViewInit {
    ...
    private getDataset(): IFinancialPlanningChart {
        ...
        return {
            year: this.selectedYear,
            budget: dataset!.budget,
            baselineSeries: { name: dataset!.baselineSeries.name, series: dataset!.baselineSeries.series},
            plannedSeries: { name: dataset!.plannedSeries.name, series: dataset!.plannedSeries.series},
