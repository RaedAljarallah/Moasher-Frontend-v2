...
import {IDetailPageState} from "../../../shared/detail-page/detail-page.component";
...
export class InitiativesListComponent implements OnInit, OnDestroy {
    ...
    public async showDetail(state: IDetailPageState): Promise<void> {
        await this.router.navigateByUrl(`initiatives/${state.id}`, { state: state })
    }
